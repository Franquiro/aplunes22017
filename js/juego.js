...
function aumentarMovimiento(){
	if(mezclado){
		console.log(grilla);
		movimientos++;
		var contador = document.getElementById("contador");
		if(movimientos > 20)
			contador.innerHTML = "<span style='color:red;'>"+movimientos+"</span>";
		else contador.innerText = movimientos;
	}	
}
...
//DOM
	...
	//busco los elementos que quiero reemplazar
	...
	//busco el padre de ambos elementos
	var padre = elemento1.parentNode;
	
	//clono los elementos en auxiliares
	var aux1 = elemento1.cloneNode(true);
	var aux2 = elemento2.cloneNode(true);

	//reemplazo los elementos, cruzados
	
	padre.replaceChild(aux2,elemento1);
	padre.replaceChild(aux1,elemento2);
